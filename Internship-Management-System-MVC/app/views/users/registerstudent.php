    ...
    <div class="form">
        <form action="<?php echo URLROOT; ?>/users/registerstudent" method="post">
				...
				<div>
					...
					<input type="text" name="email" value="<?php echo $data['email']?>" placeholder="Student Email Address">
					<br>
        		...
        		<div><a href="<?php echo URLROOT; ?>/users/registeremployer"><label>Sign up as an Employer</label></a></div>
				<div>
