...
require_once "InternshipCoordinator.php";
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if(empty(trim($_POST["email"]))){
    ...
    && empty($first_name_err) && empty($last_name_err)){
      new InternshipCoordinator($user_name,$password,$email,$first_name,$last_name);
      echo "<script type='text/javascript'>alert('Internship Coordinator User successfully created!');</script>";
...
<head>
    <meta charset="UTF-8">
    <title>Create Internship Coordinator User</title>
...
<body>
  ...
  <?php if(isLoggedInAdmin()){
    ...
    <h1>Create A Internship Coordinator User</h1>
    <div class="form">
